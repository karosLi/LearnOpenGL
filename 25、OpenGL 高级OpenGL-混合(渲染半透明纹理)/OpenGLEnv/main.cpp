...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int cubeTexture = loadTexture(FileSystem::getPath("marble.jpeg").c_str());
    unsigned int floorTexture = loadTexture(FileSystem::getPath("metal.png").c_str());
    unsigned int transparentTexture = loadTexture(FileSystem::getPath("blending_transparent_window.png").c_str());
