...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture(FileSystem::getPath("bricks2.jpeg").c_str());
    unsigned int normalMap  = loadTexture(FileSystem::getPath("bricks2_normal.jpeg").c_str());
    unsigned int heightMap  = loadTexture(FileSystem::getPath("bricks2_disp.jpeg").c_str());
